    ...
    TokenErrorReporter
{
    ...
    function initialize(
        ...
        uint err = _setPeridottroller(peridottroller_);
    ...
    function transferTokens(
        ...
        uint allowed = peridottroller.transferAllowed(
            address(this),
            src,
            dst,
            tokens
        ...
        uint srpTokensNew = accountTokens[src] - tokens;
    ...
    function mintFresh(address minter, uint mintAmount) internal {
        ...
        uint allowed = peridottroller.mintAllowed(
            address(this),
            minter,
            mintAmount
        );
    ...
    function redeemFresh(
        ...
        uint allowed = peridottroller.redeemAllowed(
            address(this),
            redeemer,
            redeemTokens
        );
    ...
    function borrowFresh(address payable borrower, uint borrowAmount) internal {
        ...
        uint allowed = peridottroller.borrowAllowed(
            address(this),
            borrower,
            borrowAmount
        );
    ...
    function repayBorrowFresh(
        ...
        uint allowed = peridottroller.repayBorrowAllowed(
            address(this),
            payer,
            borrower,
            repayAmount
    ...
    function liquidateBorrowInternal(
        ...
        uint error = pTokenCollateral.accrueInterest();
        if (error != NO_ERROR) {
    ...
    function liquidateBorrowFresh(
        ...
        uint allowed = peridottroller.liquidateBorrowAllowed(
            address(this),
        ...
        (uint amountSeizeError, uint seizeTokens) = peridottroller
    ...
    function seizeInternal(
        ...
        uint allowed = peridottroller.seizeAllowed(
            address(this),
            seizerToken,
            liquidator,
            borrower,
